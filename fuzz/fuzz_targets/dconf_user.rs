//! §13: a user's dconf database, written by that user, parsed as gvdb.
#![no_main]
...
fuzz_target!(|data: &[u8]| {
    unbidden_fuzz::feed_with("home/fuzz/.config/dconf/user", SETUP, Box::new(desktop::Desktop), false, data);
});
